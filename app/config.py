...
class Config:
    ...
    JWT_TOKEN_LOCATION=['cookies']; JWT_COOKIE_SECURE=os.getenv('FLASK_ENV')=='production'; JWT_COOKIE_HTTPONLY=True; JWT_COOKIE_SAMESITE='Lax'; JWT_COOKIE_CSRF_PROTECT=True; JWT_CSRF_IN_COOKIES=True; JWT_CSRF_HEADER_NAME='X-CSRF-TOKEN'
